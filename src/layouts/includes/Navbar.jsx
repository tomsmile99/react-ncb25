...
const Navbar = ({
  ...
  employeeCount,
  getcount,
  getemployee_contain_Count,
  getcountidea,
  // getemployee_contain_Counts,
  getemployee_contain_mes_Counts,
  getemployee_contain_em_Counts,
  getemployee_contain_boss_Counts,
  getemployee_contain_f_Counts,
}) => {
  ...
  return (
    <aside className="main-sidebar sidebar-light-primary sidebar-minimal">
      {/* Brand */}
      <NavLink to="/" className="brand-link brand-minimal" end>
        <img
          ...
          >
            ...
            {canSeeProbationGroup && (
              <>
                ...
                {ifshowmenu === 1 && (
                  <li className="nav-item blink-smooth">
                    <NavLink to="/ProposeIdea" className={navClass}>
                      <FcIdea className="" />
                      <p>เสนอแนวคิด / แสดงความรู้สึก</p>
                    </NavLink>
                  </li>
                )}
              </>
            ...
            {/* เจ้าหน้าที่งานสรรหาและประเมิน */}
            {canSeeRecruitAdminGroup && (
              <>
                <li
                  className="nav-header header-minimal"
                  style={{
              ...
              <>
                ...
                <li className="nav-item">
                  <NavLink to="/reportNCBLiteMain" className={navClass}>
                    <TbReportSearch className="" style={{ fontSize: "19px" }} />
                ...
                <li className="nav-item">
                  ...
                  <NavLink to="/ReportNCBLiteMainOut" end className={navClass}>
                    <RiTeamLine
                      className=""
                      style={{ color: "#06407aff" ,fontSize :'16px' }}
                    />
