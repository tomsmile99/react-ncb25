...
import AdminViewfollow_Send_consent from "../../setreadDatas/admin/AdminViewfollow_Send_consent";
            ...
            <div className="row mb-2 mt-2">
              <div className="col-sm-12 col-md-4">
                ...
                >
                  ...
                  />
                  ติดตามสถานะใบนำส่งต้นฉบับหนังสือให้ความยินยอม
                </h1>{" "}
              </div>
