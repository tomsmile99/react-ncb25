...
import SalepersonView_Litemain_Outsidefinish from "../../setreadDatas/salepersonView/SalepersonView_Litemain_Outsidefinish";


import { BiSolidMessageSquareEdit } from "react-icons/bi";
import { AiOutlineFileProtect } from "react-icons/ai";
const sale_CheckCredit_Outsidefinish = () => {
  return (
    <>
      <div>
          ...
          <div className="container-fluid">
            ...
            <div className="row mb-2 fadeIn">
              <div className="col-md-12"> 
                <SalepersonView_Litemain_Outsidefinish /> 
              </div>
            </div>
          </div>
          {/* /.container-fluid */}
...
export default sale_CheckCredit_Outsidefinish;
