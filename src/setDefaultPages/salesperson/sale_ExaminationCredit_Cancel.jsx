...
import SalepersonView_Examination_Cancel from "../../setreadDatas/salepersonView/SalepersonView_Examination_Cancel";

import { TbDeviceIpadCancel } from "react-icons/tb";
import { BiSolidMessageSquareEdit } from "react-icons/bi";
import { AiOutlineFileProtect } from "react-icons/ai";
const sale_ExaminationCredit_Cancel = () => {
  return (
    <>
      <div>
          ...
          <div className="container-fluid">
            ...
            <div className="row mb-2 fadeIn">
              <div className="col-md-12">
                <SalepersonView_Examination_Cancel />
              </div>
            </div>
          </div>
          {/* /.container-fluid */}
...
export default sale_ExaminationCredit_Cancel;
