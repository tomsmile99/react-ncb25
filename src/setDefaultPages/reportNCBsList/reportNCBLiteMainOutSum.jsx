...
import ReportNCBLiteMainOutSum from "../../setreadDatas/reportExcellist/reportNCBLiteOutSum";

const reportNCBLiteMainOutSum = () => {
  return (
    <>
      <div>
            ...
            <div className="row mb-3 mt-2 align-items-center">
              ...
              <div className="col-sm-12 col-md-6">
                <ol className="breadcrumb float-sm-right mb-0">
                  ...
                  รายงานทะเบียนการขอสืบค้นข้อมูลเครดิตของลูกค้า (สำหรับบุคคลภายนอก)
                  </li>
                </ol>
              </div>
            </div>
             <hr style={{ marginTop: "0.5rem", marginBottom: "1.5rem" }} />
             <ReportNCBLiteMainOutSum/>
...
export default reportNCBLiteMainOutSum;
