...
import ReportNCBLiteMainOut from "../../setreadDatas/reportExcellist/reportNCBLiteOut";

const reportNCBLiteMainOut = () => {
  return (
    <>
      <div>
...
export default reportNCBLiteMainOut;
