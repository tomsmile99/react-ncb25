...
import Approver_manager from '../../setreadDatas/executive_manager/Approver_manager';

import { BiSolidMessageSquareEdit } from "react-icons/bi";
const resourcesManager_contain = ({
  FullnamePer,
  PerPhotoProfile_N,
  PerPST_N,
  PerWP_N,
          ...
          <div className="container-fluid">
            <div className="row mb-2 mt-2">
              ...
              <div className="col-sm-12 col-md-8">
                <ol className="breadcrumb float-sm-right">
                  ...
                  <li className="breadcrumb-item">อนุมัติผลการบรรจุพนักงาน</li>
            ...
            <div className="row mb-2 fadeIn">
              <div className="col-md-12">
                <Approver_manager  FullnamePer={FullnamePer}
...
export default resourcesManager_contain