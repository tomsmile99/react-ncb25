...
import MentorReadData_history_Viewmain from "../../setreadDatas/mentor/MentorReadData_history_Viewmain";
import { BiSolidMessageSquareEdit } from "react-icons/bi";

// const [searchParams] = useSearchParams();
import { useLocation } from "react-router-dom";

const Mentor_ReviewHistory = () => {
          ...
          <div className="container-fluid">
            <div className="row mb-2 mt-2">
              ...
              <div className="col-sm-12 col-md-8">
                <ol className="breadcrumb float-sm-right">
                  ...
                  <li className="breadcrumb-item">ประวัติการประเมิน</li>
            ...
            <div className="row mb-2 fadeIn">
              <div className="col-md-12">
                ...
                <MentorReadData_history_Viewmain
...
export default Mentor_ReviewHistory;
