...
import MentorReadData_history from "../../setreadDatas/mentor/MentorReadData_history";

import { BiSolidMessageSquareEdit } from "react-icons/bi";
const Mentor_DataHistory = ({
  FullnamePer,
  PerPhotoProfile_N,
  PerPST_N,
  PerWP_N,
            ...
            <div className="row mb-2 mt-2">
              <div className="col-sm-12 col-md-4">
                ...
                >
                  ...
                  />
                  ประวัติการประเมิน / รับทราบผล การประเมินพนักงานทดลองงาน
                </h1>{" "}
              </div>
...
export default Mentor_DataHistory;
